  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        className="text-center text-5xl dark:text-darkHover"
      >
        About me
      </motion.h2>
      <motion.div
      ...
      >
        ...
        >
          ...
          >
            <Image
              ...
              alt="user"
              className="w-ful rounded-3xl cursor-pointer"
            />
          </motion.div>
        </motion.div>
        <motion.div
        ...
        >
          ...
          <motion.ul
            ...
            className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 max-w-2xl"
          >
          ...
          <motion.h4
            ...
            className="my-6 text-gray-700   dark:text-white/80 dark:text-darkHover"
          >
            Tools I Use
          </motion.h4>
          <motion.ul
